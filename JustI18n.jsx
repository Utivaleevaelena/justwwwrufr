...
const JAW_STR = {
  ...
  ru: {
    ...
    hero: {
      ...
      build: 'Записаться на консультацию', estimate: 'Узнать цену',
    ...
    pricing: {
      ...
      finalStars: 'Большинство проектов начинается с бесплатного 30-минутного разговора.', finalCta: 'Записаться на консультацию',
      plans: [
      ...
      extras: [['camera','Фотография','от 90 €'],['video','Видео','от 150 €'],['palette','Логотип','от 120 €'],['sparkles','Фирменный стиль','от 250 €'],['shopping-cart','Интернет-магазин','от 350 €'],['calendar','Система записи','от 90 €'],['bot','AI-ассистент в чате','от 150 €'],['globe','Несколько языков','от 60 €/язык'],['home','Хостинг','от 10 €/мес'],['link','Домен','от 15 €/год'],['map-pin','Профиль в Google','от 40 €'],['edit-3','SEO-тексты','от 30 €/страница']],
    ...
    modal: {
      title: 'Записаться на консультацию', desc: 'Спокойный разговор на 30 минут. Без давления, без уловок — только честный совет.',
      dateLabel: 'Дата', timeLabel: 'Время', tzNote: 'Время указано по центральноевропейскому (Варшава).',
    ...
    contact: {
      ...
      name: 'Имя', email: 'Email', phone: 'Телефон', business: 'Компания', message: 'Сообщение (необязательно)', promo: 'Промокод (если есть)', planPrefix: 'Вы выбрали:',
  ...
  fr: {
    ...
    pricing: {
      ...
      extras: [['camera','Photographie','à partir de 90 €'],['video','Vidéo','à partir de 150 €'],['palette','Logo','à partir de 120 €'],['sparkles','Identité de marque','à partir de 250 €'],['shopping-cart','Boutique en ligne','à partir de 350 €'],['calendar','Système de réservation','à partir de 90 €'],['bot','Assistant IA','à partir de 150 €'],['globe','Plusieurs langues','à partir de 60 €/langue'],['home','Hébergement','à partir de 10 €/mois'],['link','Nom de domaine','à partir de 15 €/an'],['map-pin','Fiche Google','à partir de 40 €'],['edit-3','Rédaction SEO','à partir de 30 €/page']],
    ...
    modal: {
      ...
      dateLabel: 'Date', timeLabel: 'Heure', tzNote: 'Heure indiquée en heure de Varsovie (CET/CEST).',
    ...
    contact: {
      ...
      name: 'Nom', email: 'E-mail', phone: 'Téléphone', business: 'Entreprise', message: 'Message (facultatif)', promo: 'Code promo (facultatif)', planPrefix: 'Vous avez choisi :',
